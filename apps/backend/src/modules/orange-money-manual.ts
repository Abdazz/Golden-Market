...
type OrangeMoneyManualOptions = {
  phone_number?: string
  account_name?: string
}

/**
 * Provider de paiement manuel Orange Money (Golden Market).
 *
...
export class OrangeMoneyManualService extends AbstractPaymentProvider<OrangeMoneyManualOptions> {
  static identifier = "orange-money-manual"

  private readonly phoneNumber: string
  private readonly accountName: string

  constructor(container: any, options: OrangeMoneyManualOptions) {
  ...
  private getInstructions() {
    return {
      ...
      note: "Envoyez le montant exact en FCFA par Orange Money, puis confirmez votre commande. Le marchand la validera dès réception du paiement.",
    }
  }
...
export default ModuleProvider(Modules.PAYMENT, {
  services: [OrangeMoneyManualService],
})