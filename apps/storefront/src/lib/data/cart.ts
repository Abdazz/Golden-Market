...
export async function setAddresses(currentState: unknown, formData: FormData) {
  try {
    ...
    // Pas de formulaire de facturation séparé : ce store ne vend qu'au
    // Burkina Faso avec paiement Mobile Money / à la livraison, la
    // distinction adresse de livraison vs facturation n'a pas d'usage réel
    // ici (Stripe, seul moyen de paiement à s'en servir, ne l'exploite que
